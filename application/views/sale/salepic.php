...
<tr>
		<td colspan="2" style="font-weight: bold;font-size: 50px;color: red;text-align: center;vertical-align:middle;">
...
<button ng-disabled="listsale==''" type="submit" ng-if="printer_ul !='0'" class="btn btn-warning btn-sm" ng-click="Checkbillip()" style="width: 100%;font-size: 16px;"><?php echo $lang_checkbill;?></button>
		...
		<tr >
			...
			<span class="glyphicon glyphicon-briefcase" aria-hidden="true"></span>({{customer_wallet | number}}) ชำระเงินจากกระเป๋า
				...
				<button ng-disabled="listsale==''" ng-click="Opengetmoneymodal()" class="btn btn-lg btn-primary" style="width:100%;">
				รับเงิน</button>
...
<button ng-if="printer_ul !='0'" class="btn btn-primary btn-lg" ng-click="printDivminiip()"><?=$lang_receipt?></button>

<button ng-if="printer_ul =='0'" class="btn btn-primary btn-lg" ng-click="printDivmini()"><?=$lang_receipt?></button>

<hr />
<button type="button" class="btn btn-default btn-sm" ng-click="clickokafterpay()"><?=$lang_close?></button>
...
<td valign="top">
<center>
	<h3>{{product_name_num}}</h3>

<select ng-model="productaddqty" class="form-control" style="font-size: 30px;font-weight: bold;text-align: center;width: 100px;height: 50px;">
...
<button type="button" class="btn btn-success btn-lg" ng-click="Addpushproductcode(productcode)"><?=$lang_confirm?></button>
...
<div class="modal fade" id="Opencheckbill">
	<div class="modal-dialog modal-sm" style="width:370px;">
		<div class="modal-content">
